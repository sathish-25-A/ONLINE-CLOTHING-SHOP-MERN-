  ...
  return (
    <div className="p-4">
       <form className='m-auto w-full max-w-md  shadow flex flex-col p-3 bg-white' onSubmit={handleSubmit}>
        ...
        <input type={"text"}   className='bg-slate-200 p-1 my-1'id="name"  name="name" onChange={handleOnChange} value={data.name}/>
        ...
        <select className='bg-slate-200 p-1 my-1' id='category' name='category' onChange={handleOnChange} value={data.category}>
          ...
          <option value={"brand"}>Branded Dress</option>
          <option value={"womenshirt"}>Women T-Shirt</option>
        </select>
        ...
        <textarea rows={2} value={data.description} className='bg-slate-200 p-1 my-1 resize-none' id='description' name='description' onChange={handleOnChange}></textarea>
